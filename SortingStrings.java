...
public class StoringDataInAFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // /Users/kendrabooker/Documents/my_future_cars.txt
        ...
        for(car newCar1 : newCar){
            for(car newCar2 : newCar){
                ...
                if(newCar1.make.compareTo(newCar2.make) < newCar2.make.compareTo(newCar1.make)){
                
                    newTemp = newCar1.make;
                    newCar1.make = newCar2.make;
                    newCar2.make = newTemp;
                }
            }
        }
